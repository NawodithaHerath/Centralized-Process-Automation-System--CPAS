<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:blue; color:white;">All ongoing audit </h5>
            ...
            <a href="<?= base_url('/Development/development/public/AuditReplyingOfficerDashboard/'.session()->get('EmpNo')) ?>" class="btn btn-secondary float-right">Back</a>
            <div class="row">
...
window.onload =   onPageLoad;
    ...
    function fetchcreatedauditall(audityear,entityid){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/CurrentOngoingAuditOfficerReplyAdd')?>",
            method:"POST",
            data:{
                audityear:audityear,
                entityid:entityid
