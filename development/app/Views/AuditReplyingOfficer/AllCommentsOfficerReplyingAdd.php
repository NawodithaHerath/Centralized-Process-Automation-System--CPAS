<div class="container-fluid ">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:blue; color:white;">All Comments Assigned for replying </h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">

            <Div><h5>  All comments assigned for replying and their details </h5></Div> 
            <a href="<?= base_url('/Development/development/public/allOngoingAuditOfficerReplyingAdd/'.session()->get('EmpNo')); ?>" class="btn btn-secondary float-right">Back</a>
            ...
            <tbody>
                ...
                <td><a href="<?= base_url('/Development/development/public/CommentOfficerReplyingAdd/'.$row['comment_id']); ?>" class="btn btn-secondary">View</a></td>
                </tr>
                <?php endforeach; ?>    
                <?php endif; ?> 
            </tbody>
