    ...
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-3 pb-3 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px;">All First Sub check Areas</h5>
            ...
            <tbody>
                ...
                <td><a href="<?= base_url('/Development/development/public/firstSubAreaEdit/'.$row['firstsubarea_id']); ?>" class="btn btn-secondary">Edit</a></td>
                <td><a href="<?= base_url('/Development/development/public/firstSubAreaDeleted/'.$row['firstsubarea_id']); ?>" class="btn btn-danger " onclick="return confirm('Do you realy need to delete selected item?')" >Delete</a></td>
                </tr>
                <?php endforeach; ?>    
                <?php endif; ?>
            </tbody>
