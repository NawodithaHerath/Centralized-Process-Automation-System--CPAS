<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h4 style=" border: 1px solid; padding: 10px; background-color:blue; color:white;">Entered Comment Viewing and Editing</h4>
        ...
        <?php $setstatusreject = "Reject"  ?>
            ...
            <form name="commentform" id="commentform" action="/Development/development/public/OngoingCommentEdit/<?php echo $commentdetails['comment_id'];?>" onsubmit="return  validateFormChecklist()" method="post">
                ...
                <h6 class="fw-bold h5" >Checklist Details</h6>
                    <div class="form-group mt-1">
                        <label for="mainarea_id " class="fw-bold" >Audit Main Area</label>
                            <select name="mainarea_id" class="form-control input-lg form-select" id="mainarea_id" onchange="firstareadeta(this.value);" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?> >
                        ...
                        <div class="form-group">
                                ...
                                <select name="firstsubarea_id" class="form-control input-lg form-select"  id="firstsubarea_id" onchange="checkitemdata(this.value);" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?>>                                    
                        ...
                        <div class="form-group">
                                ...
                                <select name="checkingitem_id" class="form-control input-lg form-select"  id="checkingitem_id" onchange="alreadycomment(this.value);" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?>>
                    ...
                    <div class="container border mt-1">
                        <div class="row mb-1">
                                <label for="examinperiod"class="fw-bold h5" >Sample Details</label>
                                    ...
                                    <input type="number" class="form-control input-lg" name="samplesize" onchange="likehoodcalculate()" id="samplesize" min="0" placeholder="Enter the sample size" value="<?php echo $commentdetails['samplesize']?>" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?>>
                                     
                                    </div>
                                    <div class="col-12 col-sm-4 text-left">
                                    <label for="numberofissues" >Number of Issues</label> 
                                        <input type="number" class="form-control input-lg" name="numberofissues" onchange="likehoodcalculate()" id="numberofissues" min="0" placeholder="Enter number of issues size" value="<?php echo $commentdetails['numberofissues']?>" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?>>
                                    </div>   
                                    <div class="col-12 col-sm-4 text-left">
                                ...
                                <input id="sampledetails" class="form-control"  onload="likehoodcalculate()"  value="<?php echo $commentdetails['sampledetails']?>"  name="sampledetails" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?>>
                            </div>  
                            </div> 
                        ...
                        <div class="row mb-1">
                                <label for="likelihood"class="fw-bold h5" >Overall Risk Assesment</label>
                                    <div class="col-4 col-sm-4  text-left">
                                        ...
                                        <select name="likelihood" class="form-control input-lg form-select" onchange="calculateRisk()" id="likelihood" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?> >
                                    ...
                                    <label for="significance" >Significance</label> 
                                        <select name="significance" class="form-control input-lg form-select" onchange="calculateRisk()"  id="significance" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?> >
                    ...
                    <label for="comment"class="fw-bold h5" >Audit Finding</label>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="commentheading" id="commentheading" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?> ><?php echo $commentdetails['commentheading']?></textarea>
                            </div>
                            <div class="form-group">
                                <label  class=" h6" for="commentdetails" >Comment Details</label>
                                <div class="form-group">
                                <textarea name="commentdetails" id="commentdetails" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?> ><?php echo $commentdetails['commentdetails']?></textarea>
                                </div>
                            </div>
                            <div class="form-group" >
                                <label  class=" h6" for="potentialimpact" >Potential Impact</label>
                                <div class="form-group" >
                                <textarea class="form-control" id="potentialimpact" name="potentialimpact" rows="2" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?> ><?php echo $commentdetails['potentialimpact']?></textarea>
                                </div>
                            </div>  
                            ...
                            <div class="form-group" >
                                ...
                                <div class="form-group" >
                                <textarea class="form-control" id="recommendation" name="recommendation" rows="2" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?> ><?php echo $commentdetails['recommendation']?></textarea>
                                </div>
                            </div>  
                            <div class="form-group" >
                                <label  class=" h6" for="targetdate" >Tartget Date</label>
                                <div class="form-group" >
                                <input type="date" name="targetdate" id="targetdate" value="<?php echo $commentdetails['targetdate']?>" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?>>
                                </div>
                            </div>  
                    </div>
                </div>
                        <?php if($commentdetails['status'] == 'Submit for review'|| $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted' || $commentdetails['status'] == 'Forwarded to branch'):?>
                        ...
                        <div class="row mt-5">
                            <div class="col-12 col-sm-3 text-center">
                                <button type="submit" class="btn btn-primary col-9" <?php if($commentdetails['status'] == 'Entering'|| $commentdetails['status'] == 'Rejected' ){echo'';}else{echo 'disabled';}?>> Save </button>
                            </div>
                            <div class="col-12 col-sm-3 text-center" title="To add new comment">
                                <a class="btn btn-primary col-9" href="/Development/development/public/commententering/<?php echo $commentdetails['auditid']?>"> New </a>
                            </div>
                            <div class="col-12 col-sm-3 text-center" title="Submit for reviewing">
                                <a class="btn btn-primary col-9" href="/Development/development/public/OngoingCommentSubmitReview/<?= $commentdetails['comment_id'] ?>" onclick="return confirm('Do you realy need to submite for review?')">Submit</a>
                            </div>
                            <div class="col-12 col-sm-3 text-center">
                                <a class="btn btn-secondary col-9" href="/Development/development/public/Ongoingallcomments/<?= $commentdetails['auditid'] ?>">Back</a>
                            </div>
