<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:gray; color:white;">All Assigned Audit -: Not Started</h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
            <h6 style=" border: 1px solid; padding: 10px;">Assigned All Audit</h6>
            ...
            <div class="row">
                ...
                <select name="audityear" class="form-control input-lg" id="audityear" onchange="fetchcreatedauditall(this.value,<?php echo $empno;?>);">
...
window.onload =   onPageLoad;
    ...
    function fetchcreatedauditall(audityear,empno){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/Assignedauditallworks')?>",
            method:"POST",
            data:{
                cId:audityear,
                empno:empno
