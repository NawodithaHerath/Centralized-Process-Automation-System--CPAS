<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h4 style=" border: 1px solid; padding: 10px; background-color:coral; color:white">Managment Reply Reviewing</h4>
        ...
        <?php $setstatus = "Reviewing"  ?>
            <form name="commentform" id="commentform" action="/Development/development/public/OngoingCommentReplyReviewing/<?php echo $commentdetails['comment_id'];?>" onsubmit="return  validateFormChecklist()" method="post">
                ...
                <h6 class="fw-bold h5" >Checklist Details</h6>
                        ...
                        <div class="row mb-1">
                                <label for="likelihood"class="fw-bold h5" >Overall Risk Assesment</label>
                                    <div class="col-4 col-sm-4  text-left">
                                        ...
                                        <select name="likelihood" class="form-control input-lg form-select" onchange="calculateRisk()" id="likelihood" <?php if( $commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> >
                                    ...
                                    <label for="significance" >Significance</label> 
                                        <select name="significance" class="form-control input-lg form-select" onchange="calculateRisk()"  id="significance" <?php if($commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> >
                    ...
                    <label for="comment"class="fw-bold h5" >Audit Finding</label>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="commentheading" id="commentheading" <?php if( $commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['commentheading']?></textarea>
                            </div>
                            <div class="form-group">
                                <label  class=" h6" for="commentdetails" >Comment Details</label>
                                <div class="form-group">
                                <textarea name="commentdetails" id="commentdetails" <?php if( $commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['commentdetails']?></textarea>
                                </div>
                            </div>
                            <div class="form-group" >
                                <label  class=" h6" for="potentialimpact" >Potential Impact</label>
                                <div class="form-group" >
                                <textarea class="form-control" id="potentialimpact" name="potentialimpact" rows="2" <?php if( $commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['potentialimpact']?></textarea>
                                </div>
                            </div>  
                            ...
                            <div class="form-group" >
                                ...
                                <div class="form-group" >
                                <textarea class="form-control" id="recommendation" name="recommendation" rows="2" <?php if( $commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['recommendation']?></textarea>
                                </div>
                            </div>  
                            <div class="form-group" >
                                <label  class=" h6" for="targetdate" >Tartget Date</label>
                                <div class="form-group" >
                                <input type="date" name="targetdate" id="targetdate" value="<?php echo $commentdetails['targetdate']?>" <?php  if($commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> >
                                </div>
                            </div>  
                    </div>
                </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-12 col-sm-3 text-center">
                                <button type="submit" class="btn btn-primary col-9" <?php if( $commentdetails['status'] == 'Reviewing Management Reply' || $commentdetails['status'] == 'Reviewing' || $commentdetails['status'] == 'Accepted edited comment with reply'){'';}else{echo 'disabled' ;}?> > Save </button>
                            </div>
                            <div class="col-12 col-sm-3 text-center" title="To reject comment back to enterer">
                                <a class="btn btn-primary col-9" href="/Development/development/public/CommentReplyReviewingReject/<?php echo $commentdetails['comment_id']?>" onclick="return confirm('Do you realy need to reject comment for returning back to enterer?')"> Reject </a>
                            </div>
                            <div class="col-12 col-sm-3 text-center" title="Accept comment  submitted by enterer">
                                <a class="btn btn-primary col-9" href="/Development/development/public/CommentReplyReviewingAccepted/<?= $commentdetails['comment_id'] ?>" onclick="return confirm('Do you realy need to accept the edited comment ?')">Accept Comment</a>
                            </div>
                            <div class="col-12 col-sm-3 text-center">
                                <a class="btn btn-secondary col-9" href="/Development/development/public/OngoingReplyReviewAllComments/<?= $commentdetails['auditid'] ?>">Back</a>
                            </div>

                            <div class="mt-2">
                            <a class="btn btn-danger col-3 float-right" href="/Development/development/public/CommentReplyReviewManagmentAccept/<?= $commentdetails['comment_id'] ?>" onclick="return confirm('Do you realy need to accept the managment reply? After accepting further changes can not be done.')">Accept management reply</a>
                            </div> 
                        </div>  
                    </form>   
            </div>   
