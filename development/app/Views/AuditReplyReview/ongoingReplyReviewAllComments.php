<div class="container-fluid ">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:coral; color:white">Managment Reply Reviewing - All Comments Management Reply Submitted for Review</h5>
            ...
            <a href="<?= base_url('/Development/development/public/AuditReplyReview/'.session()->get('EmpNo')); ?>" class="btn btn-secondary float-right">Back</a>
            ...
            <tbody>
                ...
                <td><a href="<?= base_url('/Development/development/public/OngoingCommentReplyReviewing/'.$row['comment_id']); ?>" class="btn btn-secondary">View</a></td>
                <td><a href="<?= base_url('/Development/development/public/ReplyReviewForwardBranch/'.$row['comment_id']); ?>" class="btn btn-secondary" onclick="return confirm('Do you realy need to forward selected comment to branch ?')" >Forward</a></td>
                </tr>
                <?php endforeach; ?>    
                <?php endif; ?> 
            </tbody>
