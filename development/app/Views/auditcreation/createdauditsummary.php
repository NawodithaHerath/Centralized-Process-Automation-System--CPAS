    ...
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px;">All created audit</h5>
            ...
            <div class="row">
                ...
                <div class="col-6 col-sm-3 text-left mt-3 ">
                <label for="myInput4 " class="fw-bold text-primary" >Seach from Audit Status</label> 
                <input class="form-control input-lg border-primary" type="text" id="myInput4" onkeyup="myFunction4()" placeholder="Search for status.." title="Type status">
                </div>
            </div>
...
function onPageLoad() {
    ...
    function fetchcreatedauditall(audityear){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/createdauditdetailallyearly')?>",
            method:"POST",
            data:{
                cId:audityear
            },
