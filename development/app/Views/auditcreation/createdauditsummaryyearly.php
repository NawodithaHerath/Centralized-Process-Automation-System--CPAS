<div class="container-fluid">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px;">All Created Audit For Team Assigning</h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">

            <Div><h5> Created all audit</h5></Div> 
            <div class="row">
                <div class="col-12 col-sm-5  text-left">
                <label for="audityear " class="fw-bold" >Select audit Year</label>
                <select name="audityear" class="form-control input-lg form-select" id="audityear" onchange="fetchcreatedaudityearly(this.value);fetchcreatedauditall(this.value);">
            ...
            <div class="row">    
                ...
                <input class="form-control input-lg" type="text" id="myInput2" onkeyup="myFunction2()" placeholder="Search for Entity.." title="Type in a name">
                </div>
                <div class="col-6 col-sm-3 text-primary text-left mt-3">
                ...
                <div class="col-6 col-sm-3 text-primary text-left mt-3">
                <label for="myInput4 " class="fw-bold" >Seach for Audit Status</label> 
                <input class="form-control input-lg" type="text" id="myInput4" onkeyup="myFunction4()" placeholder="Search for status.." title="Type status">
                </div>
            </div>
...
function onPageLoad() {
    ...
    function fetchcreatedauditall(audityear){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/createdauditdetailallnew')?>",
            method:"POST",
            data:{
                cId:audityear
            },
