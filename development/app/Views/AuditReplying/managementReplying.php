...
<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h4 style=" border: 1px solid; padding: 10px; background-color:blue; color:white;">Recieved Comment For Replying</h4>
            ...
            <form name="commentformreply" id="commentformreply" action="/Development/development/public/CommentReplyingAdd/<?php echo $commentdetails['comment_id'];?>" onsubmit="return " method="post">
            ...
            <div class="container border mt-1">         
                    <div class="row m-1">
                            ...
                            <div class="col-12 col-sm-3 text-center" title="To Refresh comment">
                                <a class="btn btn-primary col-9" href="/Development/development/public/CommentReplyingAdd/<?php echo $commentdetails['comment_id']?>"> Refresh </a>
                            </div>
                            <div class="col-12 col-sm-3 text-center" title="Submit for reviewing">
                                <a class="btn btn-primary col-9" href="/Development/development/public/OngoingCommentReplySubmitReview/<?= $commentdetails['comment_id'] ?>" onclick="return confirm('Do you realy need to submite for review?')">Submit</a>
                            </div>
                            <div class="col-12 col-sm-3 text-center">
                                <a class="btn btn-secondary col-9" href="/Development/development/public/sessionauditidReplyingAdd/<?= $commentdetails['auditid'] ?>">Back</a>
                            </div>
                    </div> 
