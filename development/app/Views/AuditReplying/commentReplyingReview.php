<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h4 style=" border: 1px solid; padding: 10px; background-color:green; color:white">Recieved Comment For Revewing</h4>
        ...
        <?php $setstatusreject = "Reject"  ?>
            ...
            <form name="commentform" id="commentform" action="/Development/development/public/CommentReplyingReview/<?php echo $commentdetails['comment_id'];?>" onsubmit="return  validateFormTargetdate()" method="post">
