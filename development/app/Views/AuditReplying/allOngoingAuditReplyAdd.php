<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:blue; color:white;">All ongoing audit assinged for  management reply  </h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
            <h6 style=" border: 1px solid; padding: 10px;"> All ongoing audit, for adding managment reply </h6>
...
window.onload =   onPageLoad;
    ...
    function fetchcreatedauditall(audityear,entityid){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/CurrentOngoingAuditReplyAdd')?>",
            method:"POST",
            data:{
                audityear:audityear,
                entityid:entityid
