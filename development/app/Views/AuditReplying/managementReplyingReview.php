...
<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h4 style=" border: 1px solid; padding: 10px; background-color:green; color:white">Recieved Comment For Reviewing</h4>
            ...
            <div class="container border">
                    <div class="col-4 col-sm-4 fw-bold text-left">
                            ...
                            <select name="ManagerResponse" class="form-control input-lg form-select" id="ManagerResponse" <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?>>
                ...
                <div class="form-group mt-4">
                    <label  class=" h6" for="replyDetails" >Manager Reply Details</label>
                        ...
                        <textarea name="replyDetails" id="replyDetails" <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> ><?php if(isset($postdata)){echo $postdata['replyDetails'];}else{echo "";}?></textarea>
                        </div>
                </div>

                <div class="form-group mt-1">
                        <label for="responsiblePerson " class="fw-bold" >Responsible Officer</label>
                            <select name="responsiblePerson" class="form-control input-lg form-select" id="responsiblePerson" <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                    ...
                    <div class="row m-1">
                        ...
                        <select name="rectification"  class="form-control input-lg form-select" id="rectification" onchange="reactificationstatus()" <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?>>
                        ...
                        <div id="rectifiedDate" class="hidden">
                            ...
                            <input class="form-control" type="date" id="rectifiedDate" name="rectifiedDate" value="<?php if(isset($postdata)){echo $postdata['rectifiedDate'];}else{echo "";}?>" <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                                <div class="form-group" >
                                <label class="col-12 col-sm-6 fw-bold" for="rectificationAction">Action taken for rectification</label>
                                <textarea class="form-control" id="rectificationAction" name="rectificationAction" rows="2"  <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?>   ><?php if(isset($postdata)){echo $postdata['rectificationAction'];}else{echo "";}?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="targetDate" class="hidden">
                            ...
                            <input  class="form-control" type="date" id="targetDateInput" name="rectificationTargetDate" value="<?php if(isset($postdata)){echo $postdata['rectificationTargetDate'];}else{echo "";}?>"  <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                            </div>
                        </div>
                    </div> 
                ...
                <div class="row m-1 fw-bold" >
                        ...
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg"  type="checkbox" value="HR" id="HR" name="HR" <?php if(!$postdata['HR']==''){echo 'checked';}?> <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                            <label class="form-check-label" for="HR">HR</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="IT" id="IT" name="IT" <?php if(!$postdata['IT']==''){echo 'checked';}?> <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                            <label class="form-check-label" for="IT">IT</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="Execution" id="Execution" name="Execution" <?php if(!$postdata['Execution']==''){echo 'checked';}?> <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                            <label class="form-check-label" for="Execution">Execution</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="Process" id="Process" name="Process" <?php if(!$postdata['Process']==''){echo 'checked';}?> <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                            <label class="form-check-label" for="Process">Process</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="Policies" id="Policies" name="Policies" <?php if(!$postdata['Policies']==''){echo 'checked';}?> <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> >
                    ...
                    <label class="col-12 col-sm-6 fw-bold" for="rootcauseDetails"  >Details for Root Cause</label>
                        <textarea class="form-control m-1" id="rootcauseDetails" name="rootcauseDetails" rows="2"  <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> ><?php if(isset($postdata)){echo $postdata['rootcauseDetails'];}else{echo "";}?></textarea>
                </div>

            </div>
            <div class="container border mt-1">         
                    <div class="row m-1">
                            <div class="col-12 col-sm-3 text-center" title="To save management reply to chenges" >
                                <button type="submit" class="btn btn-primary col-9" <?php if($postdata['replyStatus'] == 'Submit for review' || $postdata['replyStatus'] =='Reviewing Reply'){echo '';}else {echo "disabled";}?> > Save </button>
                            </div>
                            <div class="col-12 col-sm-3 text-center" title="To accept management reply">
                                <a class="btn btn-primary col-9" href="/Development/development/public/OngoingCommentReplyReviewedAccepted/<?php echo $commentdetails['comment_id']?>" onclick="return confirm('Do you realy need to accept the management reply to audit')"> Accept </a>
                            </div>
                            <div class="col-12 col-sm-3 text-center" title="Submit management reply to audit">
                                <a class="btn btn-primary col-9" href="/Development/development/public/OngoingCommentReplyReviewedSubmitAudit/<?php echo $commentdetails['comment_id']?>"  onclick="return confirm('Do you realy need to submite the management reply to audit')" >Submit</a>
                            </div>
                            <div class="col-12 col-sm-3 text-center">
                                <a class="btn btn-secondary col-9" href="/Development/development/public/sessionauditidReplyingReview/<?= $commentdetails['auditid'] ?>">Back</a>
                            </div>
                    </div> 
