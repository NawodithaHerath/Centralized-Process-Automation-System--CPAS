...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <?php if(session()->get('isLoggedIn')): ?>
      ...
      <li class="nav-item">
        <a class="nav-link <?= ($uri->getSegment(1)) == 'dashboard' ? 'active' :null ?>" href="/Development/development/public/dashboard/">Dashboard</a>
      </li>
    ...
    <div class="text-right">
        <ul class="navbar-nav my-2 my-lg-0" >
          ...
          <li class="nav-item ">
              <a class="nav-link" href="<?= base_url('/Development/development/public/AuditFieldWork/'.session()->get('EmpNo'));?>">Home</a>
          </li>
        </ul>
    </div>
    <?php else: ?>
