<div class="container-fluid">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:DarkRed; color:white ">All Reply Completed Audit -: </h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
            <h6 style=" border: 1px solid; padding: 10px;"> All replied and completed audit with audit risk and risk grade </h6>
            <Div><h5> Employee No: <?php echo $empno;?></h5></Div> 
            <Div><h5> Entity Name: <?php echo  $entitydetails['entityname'];?>, Entity ID: <?php echo $entitydetails['entityid'];?> </h5></Div> 
            <a href="<?= base_url('/Development/development/public/AuditReplying/'.session()->get('EmpNo')) ?>" class="btn btn-secondary float-right">Back</a>
            <div class="row">
                <div class="col-12 col-sm-5  text-left">
                <label for="audityear " class="fw-bold" >Select audit Year</label>
                <select name="audityear" class="form-control input-lg" id="audityear" onchange="fetchcreatedauditall(this.value,'<?php echo $entityid;?>')">
            ...
            <thead>
                ...
                <th scope="col">Audit completed at</th>
                </tr>
            </thead>
...
window.onload =   onPageLoad;
    ...
    function onPageLoad() {
        ...
        fetchcreatedauditall(currentyear,'<?php echo $entityid;?>');
        }

    function fetchcreatedauditall(audityear,entityid){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/AllAuditReplyCompleted')?>",
            method:"POST",
            data:{
                audityear:audityear,
                entityid:entityid
