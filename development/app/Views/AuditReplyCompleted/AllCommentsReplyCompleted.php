<div class="container-fluid ">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:DarkRed; color:white">All Completed Comments </h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">

            <Div><h5>  All completed comments available under this audt and their details </h5></Div> 
            ...
            <?php if(session()->get('success')):?>
                ...
                <a href="<?= base_url('/Development/development/public/AllReplyCompleted/'.session()->get('EmpNo')); ?>" class="btn btn-secondary float-right">Back</a>    
            ...
            <tbody>
                ...
                <td><a href="<?= base_url('/Development/development/public/CommentReplyingCompleted/'.$row['comment_id']); ?>" class="btn btn-secondary">View</a></td>
                </tr>
                <?php endforeach; ?>    
                <?php endif; ?> 
            </tbody>
