<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-3 pb-3 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px;">All Checking Item</h5>
            ...
            <div><p>To export data into the excel file</p><a href="<?= base_url('/Development/development/public/ReportAdminChecklistCheckingItemExport/'.$firstsubarea_id)?>" class="btn btn-success">Export into Excel</a> </div>
            <a href="<?= base_url('/Development/development/public/ReportAdminFirstSubArea/'.$firstsubarea['mainarea_id'])?>" class="btn btn-secondary float-right">Back</a>
