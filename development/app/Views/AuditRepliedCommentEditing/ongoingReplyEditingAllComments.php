<div class="container-fluid ">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:DarkViolet; color:white"> Replied Comment Editing - All Comments Management Reply recieved</h5>
            ...
            <Div><h5> All the comment that management reply recieved</h5></Div> 
            <a href="<?= base_url('/Development/development/public/AuditReplyCommentEdit/'.session()->get('EmpNo')); ?>" class="btn btn-secondary float-right">Back</a>
            ...
            <tbody>
                ...
                <td><a href="<?= base_url('/Development/development/public/OngoingCommentReplyCommentEditing/'.$row['comment_id']); ?>" class="btn btn-secondary">View</a></td>
                </tr>
                <?php endforeach; ?>    
                <?php endif; ?> 
            </tbody>
