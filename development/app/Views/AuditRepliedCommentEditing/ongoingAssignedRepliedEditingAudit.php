<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:DarkViolet; color:white ">Replied Comment Editing- All Assigned Ongoing Audit</h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
            <h6 style=" border: 1px solid; padding: 10px;">Editing audit comment after recieving management reply</h6>
...
window.onload =   onPageLoad;
 ...
 function onPageLoad() {
    ...
    function fetchcreatedauditall(audityear,empno){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/ongoingAssignedReplyCommentEditAllAudit')?>",
            method:"POST",
            data:{
                cId:audityear,
                empno:empno
