<div class="container">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h4 style=" border: 1px solid; padding: 10px; background-color:DarkViolet; color:white">Editing Audit Comment After Receiving Management Reply</h4>
            ...
            <?php endif; ?>
                <?php if($commentdetails['status']!='Replied Comment Editing'):?>
                <div class="alert alert-warning mt-2" role="alert">
                    <h6>Management Reply Status : <?= $commentdetails['status'] ?> </h6>
                </div>
                <?php endif; ?>

        <?php $status = $commentdetails['status']?>
        <?php $setstatus = "Reviewing"  ?>
            <form name="commentform" id="commentform" action="/Development/development/public/OngoingCommentReplyCommentEditing/<?php echo $commentdetails['comment_id'];?>" onsubmit="return  validateFormChecklist()" method="post">
                ...
                <h6 class="fw-bold h5" >Checklist Details</h6>
                        ...
                        <div class="row mb-1">
                                <label for="likelihood"class="fw-bold h5" >Overall Risk Assesment</label>
                                    <div class="col-4 col-sm-4  text-left">
                                        ...
                                        <select name="likelihood" class="form-control input-lg form-select" onchange="calculateRisk()" id="likelihood" <?php if( $commentdetails['status'] == 'Replied Comment Editing'){'';}else{echo 'disabled' ;}?> >
                                    ...
                                    <label for="significance" >Significance</label> 
                                        <select name="significance" class="form-control input-lg form-select" onchange="calculateRisk()"  id="significance" <?php if( $commentdetails['status'] == 'Replied Comment Editing'){'';}else{echo 'disabled' ;}?> >
                    ...
                    <label for="comment"class="fw-bold h5" >Audit Finding</label>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="commentheading" id="commentheading" <?php if( $commentdetails['status'] == 'Replied Comment Editing'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['commentheading']?></textarea>
                            </div>
                            <div class="form-group">
                                <label  class=" h6" for="commentdetails" >Comment Details</label>
                                <div class="form-group">
                                <textarea name="commentdetails" id="commentdetails" <?php if( $commentdetails['status'] == 'Replied Comment Editing'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['commentdetails']?></textarea>
                                </div>
                            </div>
                            <div class="form-group" >
                                <label  class=" h6" for="potentialimpact" >Potential Impact</label>
                                <div class="form-group" >
                                <textarea class="form-control" id="potentialimpact" name="potentialimpact" rows="2" <?php if( $commentdetails['status'] == 'Replied Comment Editing'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['potentialimpact']?></textarea>
                                </div>
                            </div>  
                            ...
                            <div class="form-group" >
                                ...
                                <div class="form-group" >
                                <textarea class="form-control" id="recommendation" name="recommendation" rows="2" <?php if( $commentdetails['status'] == 'Replied Comment Editing'){'';}else{echo 'disabled' ;}?> ><?php echo $commentdetails['recommendation']?></textarea>
                                </div>
                            </div>  
                            <div class="form-group" >
                                <label  class=" h6" for="targetdate" >Tartget Date</label>
                                <div class="form-group" >
                                <input type="date" name="targetdate" id="targetdate" value="<?php echo $commentdetails['targetdate']?>" <?php  if( $commentdetails['status'] == 'Replied Comment Editing'){'';}else{echo 'disabled' ;}?> >
                                </div>
                            </div>  
                    </div>
                </div>
