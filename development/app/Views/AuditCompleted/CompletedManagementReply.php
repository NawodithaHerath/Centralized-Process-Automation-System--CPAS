            ...
            <div class="container border">
                ...
                <div class="form-group mt-4">
                    <label  class=" h6" for="replyDetails" >Manager Reply Details</label>
                        ...
                        <textarea name="replyDetails" id="replyDetails" disabled ><?php if(isset($replydata)){echo $replydata['replyDetails'];}else{echo "";}?></textarea>
                        </div>
                </div>
                ...
                <div class="form-group mt-1">
                    ...
                    <div class="row m-1">
                        ...
                        <div id="rectifiedDate" class="hidden">
                            ...
                            <input class="form-control" type="date" id="rectifiedDate" name="rectifiedDate" value="<?php if(isset($replydata)){echo $replydata['rectifiedDate'];}else{echo "";}?>" disabled >
                                <div class="form-group" >
                        ...
                        <div id="targetDate" class="hidden">
                            ...
                            <input  class="form-control" type="date" id="targetDateInput" name="rectificationTargetDate" value="<?php if(isset($replydata)){echo $replydata['rectificationTargetDate'];}else{echo "";}?>"  disabled >
                            </div>
                        </div>
                    </div> 
                ...
                <div class="row m-1 fw-bold" >
                        ...
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg"  type="checkbox" value="HR" id="HR" name="HR" <?php if(!$replydata['HR']==''){echo 'checked';}?> disabled >
                            <label class="form-check-label" for="HR">HR</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="IT" id="IT" name="IT" <?php if(!$replydata['IT']==''){echo 'checked';}?> disabled >
                            <label class="form-check-label" for="IT">IT</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="Execution" id="Execution" name="Execution" <?php if(!$replydata['Execution']==''){echo 'checked';}?> disabled >
                            <label class="form-check-label" for="Execution">Execution</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="Process" id="Process" name="Process" <?php if(!$replydata['Process']==''){echo 'checked';}?> disabled >
                            <label class="form-check-label" for="Process">Process</label>
                        </div>
                        <div class="col-12 col-sm-2 text-center">
                            <input class="form-check-input-lg" type="checkbox" value="Policies" id="Policies" name="Policies" <?php if(!$replydata['Policies']==''){echo 'checked';}?> disabled >
                    ...
                    <label class="col-12 col-sm-6 fw-bold" for="rootcauseDetails"  >Details for Root Cause</label>
                        <textarea class="form-control m-1" id="rootcauseDetails" name="rootcauseDetails" rows="2"  disabled ><?php if(isset($replydata)){echo $replydata['rootcauseDetails'];}else{echo "";}?></textarea>
                </div>
            ...
            <div class="container border mt-1">         
                    <div class="row m-1">
                            <div class="col-12 col-sm-3 text-center">
                                <a class="btn btn-secondary col-9" href="/Development/development/public/AllCompletedComments/<?= $commentdetails['auditid'] ?>">Back</a>
                            </div>
                    </div> 
