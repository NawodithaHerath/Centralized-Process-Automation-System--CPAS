<div class="container-fluid">
    <div class="col-12 col-sm-12 offset-sm-12 col-md-12 mt-1 pt-1 pb-1 bg-white from-wrapper " >
        ...
        <h5 style=" border: 1px solid; padding: 10px; background-color:DarkRed; color:white ">All Completed Audit</h5>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
            <h6 style=" border: 1px solid; padding: 10px;">All completed audit and risk rate granted</h6>
...
window.onload =   onPageLoad;
 ...
 function onPageLoad() {
    ...
    function fetchcreatedauditall(audityear,empno){
        $.ajax({
            url:"<?php echo base_url('Development/development/public/CompletedAllAudit')?>",
            method:"POST",
            data:{
                cId:audityear,
                empno:empno
